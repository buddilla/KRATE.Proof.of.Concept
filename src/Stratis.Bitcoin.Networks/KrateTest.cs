...
{
    public class KrateTest : BitcoinMain
    {
        public KrateTest()
        {
            this.Name = "TestNet";
            ...
            {
                [KrateBIP9Deployments.TestDummy] = new BIP9DeploymentsParameters(28, 1199145601, 1230767999),
                [KrateBIP9Deployments.CSV] = new BIP9DeploymentsParameters(0, 1456790400, 1493596800),
                [KrateBIP9Deployments.Segwit] = new BIP9DeploymentsParameters(1, 1462060800, 1493596800)
            };
